...
public class InputStreams {
    ...
    public static final cfg.io.ByteArrayInputStream create(String data) {
	return new cfg.io.ByteArrayInputStream(data.getBytes(CHARSET_UTF8));
    }

    public static final cfg.io.ByteArrayInputStream create(byte[] bytes, int offset, int length) {
	return new cfg.io.ByteArrayInputStream(bytes,offset,length);
    }
    
    public static final cfg.io.ByteArrayInputStream create(byte[] bytes) {
	return new cfg.io.ByteArrayInputStream(bytes);
    }
			      
    public static final cfg.io.ByteArrayInputStream create(int[] codepoints, int offset, int length) {
	return create(new String(codepoints,offset,length));
    }

    public static final cfg.io.ByteArrayInputStream create(int[] codepoints) {
