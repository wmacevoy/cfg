...
public class Cipher {
	...
	if (buf != _buf) {
	    System.arraycopy(_buf,0,buf,offset,length);
    ...
    public static final String encrypt(String key, String plain) {
        return hex(encrypt(null,asBytes(key),asBytes(plain)));
    }
    ...
    // NATO    alpha-charlie-delta-echo-foxtrot-hotel-juliette-mike-november-papa-rome-tango-whisky-xray-yankee-zulu";
}
